...
const customerGridImage = (props) => (
  <div className="image flex gap-4">
    <img className="rounded-full w-10 h-10 object-cover" src={props.CustomerImage} alt="employee" />{" "}
    <div>
...
const customerGridStatus = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: props.StatusBg }} className="rounded-full h-3 w-3 object-cover" />
    <p>{props.Status}</p>
  </div>
);
...
export const chatData = [
  ...
  },
  {
    ...
    desc: "Kamella sent you new message",
    time: "11:56 AM",
  },
  {
    image: avatar4,
